    ...
    <div className="bg-[#140C2C] text-white min-h-screen">
      ...
      <section className="mt-12 px-4 md:px-8">
        ...
        <div className="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          <div className="rounded-lg border shadow-sm bg-[#201A3A] hover:shadow-lg transform hover:scale-105 transition-all duration-300 p-6">
            <svg
            ...
            <h3 className="whitespace-nowrap text-2xl font-semibold leading-none tracking-tight mt-4">
          ...
          <div className="rounded-lg border shadow-sm bg-[#201A3A] hover:shadow-lg transform hover:scale-105 transition-all duration-300 p-6">
            ...
            <p className="text-sm text-muted-foreground mt-2">API &amp; Instance</p>
          </div>
          <div className="rounded-lg border shadow-sm bg-[#201A3A] hover:shadow-lg transform hover:scale-105 transition-all duration-300 p-6">
            <svg
              xmlns="http://www.w3.org/2000/svg"
